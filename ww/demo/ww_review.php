...
<head>
  ...
  .k2-ww-small-online{//因为ie6
    background-position:-82px 0px; 
  }
  .k2-ww-small.k2-ww-mobile,
  .k2-ww-samll-mobile{//因为ie6
...
<body>
  <h1>旺旺</h1>
  <h2>说明</h2>
  <p>通过旺旺ICON来显示指定淘宝id的在线、离线和移动在线的状态，并且在IE下通过点击旺旺能激活本地已安装的旺旺进行交流，如果没有安装则会引导下载，在非IE下能引导到Web旺旺。</p>
  <p>请看<a href="ww-gbk.php">GBK版本</a></p>
  <!--
...
YUI({
  ...
  */
  ...
  Y.one('#k2-ww-eg').append('<h3>使用选择符指定</h3><ol>' + 
    ...
    '<li class="k2-ww-eg-2">冰浠：<span class="k2-ww" data-wwid="冰浠"></span></li>' + 
    '<li class="k2-ww-eg-2">tinyhill<span class="k2-ww" data-wwid="tinyhill"></span></li>' +
    '<li class="k2-ww-eg-2">tinyhill<span class="k2-ww" data-wwid="tinyhill"></span></li>' +
