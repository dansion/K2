...
<h2>Y.Plugin.EditorEmotion</h2>
<p>使用 <code>editorInstance.plug(Y.Plugin.EditorEmotion); </code>来启用表情插件。</p>
...
?>
<script src="../editor-emotion.js"></script>
<script src="../editor-flash.js"></script>
<script>
YUI().use('k2-editor-simple',"k2-editor-createlink","k2-editor-emotion", "k2-editor-flash", function(Y){
	...
	simple.unplug(Y.Plugin.EditorImage);
